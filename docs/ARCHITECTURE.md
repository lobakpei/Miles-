...
最後更新：2026-07-23
基準版本：正式 v6.79.0；本 branch 加入 Phase 1A 資料搬遷及 Phase 1B typed offer refresh 候選
...
- 現行 bottom nav 仍係 `計算／規劃／首頁／優惠／攻略`，一般 Planner 第一層仍有 Beginner／Advanced gateway；新決定要求 `點賺／點用／首頁／優惠／攻略`，而 Beginner／Advanced 只屬環球票內部分流。呢個差距留待後續 Phase，Phase 0 不改 UI。
